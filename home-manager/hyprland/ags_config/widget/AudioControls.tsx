...
function EndpointControl({ endpoint }: { endpoint: Wp.Endpoint }) {
  ...
  return <centerbox tooltipText={bind(endpoint, "description")} cssClasses={["endpointControl"]}>
    <image iconName={bind(endpoint, "icon")} />
...
export default function AudioControls() {
  ...
  return (
    <box vertical cssClasses={["audioControls"]}>
